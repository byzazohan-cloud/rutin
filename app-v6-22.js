...
function setupPinKey(v){
 ...
 if(setupPinBuffer.length===4){
   if(setupPinStep===1){
     ...
     setupPinBuffer='';
     setupPinStep=2;
     setTimeout(()=>updateSetupPinDots(),120);
     return;
   }
...
function pinSetupScreen(){
 ...
 return `<div class="premiumLock setupPremiumLock">
   ...
   <div class="setupPinNote">4 HANELİ PINİNİ İKİ KEZ GİREREK OLUŞTUR.</div>
   <div class="lockVersion">V6.22</div>
 </div>`;
}
function createInitialPin(){
 // V6.22: PIN oluşturma artık ekran tuş takımı üzerinden yapılır.
}
let pinBuffer='';
