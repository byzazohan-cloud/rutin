...
const defaults={
 ...
 settings:{dailyRate:1250,hourlyRate:200,overtimeRate:250,pin:'',lock:false,reminders:true,reminderDays:2},
...
function save(){localStorage.setItem('rutin-v3',JSON.stringify(state))}
...
function settings(){
 ...
 <div class="setting clickable" onclick="openModal('backup')"><div>⇩</div><b>YEDEKLEME / GERİ YÜKLE</b><span>›</span></div>
 <div class="setting"><div>◐</div><b>TEMA</b><span>SİYAH GOLD</span></div>
...
function expenseForm(){return `<form onsubmit="submitExpense(event)">
 ...
 <button class="primary">KAYDET</button></form>`}
function nav(){
 const items=[['home','⌂','ANA SAYFA'],['work','⌁','İŞ'],['calendar','▦','TAKVİM'],['reports','▥','RAPORLAR'],['more','•••','DAHA FAZLA']];
...
function render(){
 ...
 <div class="moreGrid">
   ...
   <button onclick="go('settings')"><i>⚙</i><b>AYARLAR</b><span>PIN, YEDEKLEME, HATIRLATMA</span></button>
