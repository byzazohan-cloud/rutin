...
const defaults={
 ...
 settings:{dailyRate:1250,hourlyRate:200,overtimeRate:250,pin:'',lock:false,reminders:true,reminderDays:2,morningReminder:true,morningReminderTime:'07:00',nightReminder:true,nightReminderTime:'22:00',appearance:'dark',theme:{bg:'#000000',panel:'#000000',gold:'#d7b45c',green:'#22c55e',red:'#ff4d5a',blue:'#3b82f6'}},
...
let screen='home', modal=null, reportPeriod='month', unlocked=!state.settings.lock, calendarCursor=new Date(new Date().getFullYear(),new Date().getMonth(),1);
...
function settings(){
 ...
 <div class="setting clickable premiumSetting" onclick="exportData()"><div class="settingIcon">⇧</div><b>VERİ DIŞA AKTAR</b><span>›</span></div>
