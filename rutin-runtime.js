...
function homeHane(){
 ...
 <section class="hpSummary"><button onclick="openModal('periodDetail:todayIncome')"><small>BUGÜNKÜ GELİR</small><strong class="green">${M(ti)}</strong><span>AYRINTI ›</span></button><button onclick="openModal('periodDetail:todayExpense')"><small>BUGÜNKÜ HARCAMA</small><strong class="red">${M(te)}</strong><span>AYRINTI ›</span></button><button onclick="openModal('periodDetail:monthIncome')"><small>BU AY GELİR</small><strong class="green">${M(T.income)}</strong><span>AYRINTI ›</span></button><button onclick="openModal('periodDetail:monthExpense')"><small>BU AY HARCAMA</small><strong class="red">${M(T.expense)}</strong><span>AYRINTI ›</span></button></section>
 ...
 <div class="hpSection"><b>AYLIK DURUM</b></div><section class="hpFlow"><button onclick="openModal('periodDetail:monthIncome')"><small>GELİR</small><b class="green">${M(T.income)}</b></button><button onclick="openModal('periodDetail:monthExpense')"><small>HARCAMA</small><b class="red">${M(T.expense)}</b></button><button onclick="go('reports')"><small>KALAN</small><b>${M(remain)}</b></button></section>
